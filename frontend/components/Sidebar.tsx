          ...
          <div key={section.title} className="mb-6">
            ...
            <div className="space-y-0.5">
              {section.items.map((item) => (
                <button key={item.id} className="w-full flex items-center gap-3 px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#1c1c1e] hover:text-gray-900 dark:hover:text-gray-200 rounded-lg group transition-colors">
