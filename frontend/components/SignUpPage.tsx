...
import { Zap, Eye, EyeOff, Loader2, Moon, Sun, ArrowRight, Mail, Lock, User } from 'lucide-react';
        ...
        <div className="px-8 pb-10">
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-gray-500 dark:text-gray-400">
              Already have an account? <button onClick={onSwitchToLogin} className="text-blue-600 dark:text-blue-400 font-medium hover:underline">Sign in</button>
            </p>
          </div>
        </div>
      </div>
